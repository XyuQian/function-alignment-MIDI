...
MODEL_FACTORY = {
    "AudioLM": {
        ...
        "inference_param_list": ["audio_index", "audio_prompt", "num_samples", "audio_top_k", "audio_max_gen_len", "audio_walk_steps", "device"],
        "out": "audio_pred",
    },
    "MIDILM": {
        "model": "MIDILM",
        ...
        "inference_param_list": ["midi_index", "midi_prompt", "num_samples", "midi_top_k", "midi_walk_steps", "midi_max_gen_len", "device"],
        "out": "midi_pred",
    },
}
